...
@section('layouts.simple.css')
    ...
    <link rel="stylesheet" type="text/css" href="{{ url('assets/css/vendors/owlcarousel.css') }}">
    <link rel="stylesheet" type="text/css" href="{{ url('assets/css/vendors/range-slider.css') }}">
@endsection
