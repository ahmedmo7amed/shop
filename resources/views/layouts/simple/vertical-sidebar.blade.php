				...
				<ul class="sidebar-links" id="simple-bar">
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" style="display: {{ request()->route()->getPrefix() == '/dashboard' ? 'block;' : 'none;' }}">
							<li><a class="lan-4 {{ Route::currentRouteName()=='products.index' ? 'active' : '' }}" href="{{route('products.index')}}">{{ trans('lang.Default') }}</a></li>
					...
					<li class="sidebar-list">
						...
						<ul class="sidebar-submenu" >
							<li class=" customizer-color"><a href="{{route('products.index')}}">Boxed</a></li>
							<li class=" customizer-color"><a href="{{route('products.index')}}">RTL</a></li>
							<li class=" customizer-color dark"><a href="{{route('products.index')}}">Dark Layout</a></li>
							<li class=" customizer-color"><a href="{{route('products.index')}}">Hide Nav Scroll</a></li>
							<li class=" customizer-color"><a href="{{route('products.index')}}">Footer Light</a></li>
							<li class=" customizer-color"><a href="{{route('products.index')}}">Footer Dark</a></li>
							<li class=" customizer-color"><a href="{{route('products.index')}}">Footer Fixed</a></li>
						</ul>
					</li>
					<li class="sidebar-main-title">
						<div>
