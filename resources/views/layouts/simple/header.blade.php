<div class="page-header">
  <div class="header-wrapper row m-0">
    ...
    <div class="header-logo-wrapper col-auto p-0">
      <div class="logo-wrapper"><a href="{{ route('products.index')}}"><img class="img-fluid" src="{{ asset('assets/images/logo/logo.png') }}" alt=""></a></div>
            ...
            <div class="cart-dropdown onhover-show-div">
                ...
                <ul>
                    ...
                    @else
                            ...
                            <li>
                                <div class="media">
                                    @if($item->product->image)
                                        <img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('storage/' . $item->product->image) }}" alt="{{ $item->product->name }}">
                                    @else
                                        <img class="img-fluid b-r-5 me-3 img-60" src="{{ asset('assets/images/other-images/cart-img.jpg') }}" alt="Default Product Image">
                                    @endif
                                    ...
                                    <span class="input-group-prepend">
                                        ...
                                        <h6 class="font-primary">${{ number_format($item->product->price, 2) }}</h6>
                                    </div>
                                    <div class="close-circle">
                                        <form action="{{ route('cart.remove', $item->product) }}" method="POST" class="d-inline">
                                            @csrf
                                            <button type="submit" class="bg-danger" style="border: none; background: none; padding: 0;">
                                                <i data-feather="x"></i>
                                            </button>
                                        </form>
                                    </div>
                        ...
                        @endforeach
                        <li class="total">
                            <h6 class="mb-0">Order Total : <span class="f-right">${{ number_format($total, 2) }}</span></h6>
                        </li>
                    @endif

                    @endif
                    <li class="text-center">
                        <a class="d-block mb-3 view-cart f-w-700" href="{{ route('cart') }}">Go to your cart</a>
                        <a class="btn btn-primary view-checkout" href="{{ route('checkout') }}">Checkout</a>
                    </li>
                </ul>
            </div>
        </li>
